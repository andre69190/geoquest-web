const CACHE_NAME = 'geoquest-ec17b038';
...
const ASSETS = [
  ...
  './data/architektur.json',
  './data/architektur_ws.json',
  './data/astro_hl.json',
  ...
  './data/capitals_extended.json',
  './data/capitals_ws.json',
  './data/emob_hl.json',
  './data/emob_match.json',
  './data/emob_pin.json',
  './data/emob_ws.json',
  './data/filme_extended.json',
  './data/fluesse_extended.json',
  './data/fluesse_ws.json',
  ...
  './data/gipfel_extended.json',
  './data/gipfel_ws.json',
  './data/hunde_extended.json',
  './data/hunde_ws.json',
  './data/i18n_extra.json',
  './data/inseln_extended.json',
  './data/inseln_ws.json',
  './data/klima_extended.json',
  './data/klima_ws.json',
  './data/konsolen.json',
  './data/kultur.json',
  ...
  './data/medizin_ws.json',
  './data/metro_logos.json',
  './data/musik_extended.json',
  './data/mythologie.json',
  './data/mythologie_ws.json',
  './data/nparks_extended.json',
  './data/nparks_ws.json',
  './data/ozeane_extended.json',
  './data/ozeane_ws.json',
  ...
  './data/tiere_ws.json',
  './data/timeline.json',
  './data/webkultur_extended.json',
  './data/webkultur_ws.json',
  './data/wirtschaft_extended.json',
  './data/wirtschaft_ws.json',
