...
const MODES=[
  ...
  {id:"logic_grid",    icon:"\u{1F9E9}",title:"Logik-Gitter",          group:"new_modes",prompt:"L\u00f6se das R\u00e4tsel",                desc:"L\u00f6se geografische Logik-R\u00e4tsel",       comingSoon:true},
  {id:"travel_route",  icon:"\u{1F5FA}",title:"Reiseroute",            group:"new_modes",prompt:"K\u00fcrzeste Route?",                      desc:"Plane die k\u00fcrzeste Route zwischen St\u00e4dten",comingSoon:true},
...
function renderHomeTab(){
  ...
  function catSection(catId){
    ...
    const cards=catModes.map(m=>{
      ...
      const cardCls="mode-card"+(active?" active":"")+(cs?" coming-soon-card":"")+(!unlocked&&\!cs?" locked-card":"");
