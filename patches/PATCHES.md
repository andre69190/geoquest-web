...
| inline gen.py + neue JSONs | 427 | 2 neue Kategorien "Kino & Film" + "Musikgeschichte". 40 Filme (filme_extended.json: global, Blockbuster/Klassiker/Franchise/Indie) + 40 Künstler (musik_extended.json: Pop/Rock/Hip-Hop/Electronic/Legend). 15 neue Modi: hl_film_boxoffice/laenge/oscars/imdb/release, timeline_film_release, film_match_regisseur/drehort, hl_musik_streams/verkaeufe/grammys/gruendung, timeline_musik_gruendung, musik_match_land/hit. Neue Generatoren genFilmeHLExt/MatchExt + genMusikHLExt/MatchExt. validate_content.py: check_filme_extended + check_musik_extended. i18n-Fix (doppelter en-Block). MODES 814→829. verify: 148/148 |
| inline gen.py + neue JSONs | 428 | 2 neue Kategorien: Mythologie & Sagenwelt (40 Gottheiten: GR/NO/ÄG/RO/JP/AZ/MES — mythologie.json) + Architektur & Megabauten (40 Bauwerke — architektur.json). 11 neue Modi: myth_match_domain/kultur/typ/roemisch, myth_pin_herkunft, hl_arch_height/span/baujahr (lowerWins!), arch_match_land/typ, arch_pin_megaprojects. Neue Generatoren: genMythMatchExt, genMythPinQ, genArchHLExt, genArchMatchExt, genArchPinQ. i18n PL+EN (+22 Strings). Validator: check_mythologie + check_architektur. MODES 829→840. verify: 150/150 |
| inline gen.py + neue JSONs | 429 | RETROFIX Phase 428: MYTH_DATA/ARCH_DATA Placeholder fehlten (JS-Konstanten + Python-Loading + replace-Aufrufe nachgetragen). 2 neue Kategorien: Literatur & Comics (literatur_extended.json, 40 Werke: Roman/Comic/Manga/Kinderbuch) + KI/Robotik/Hardware (robotik_extended.json, 40 Systeme inkl. WRO/FLL/ChatGPT/AlphaGo/KUKA). 12 neue Modi: hl_lit_sales/release(lowerWins!), lit_match_autor/land/protagonist, timeline_lit_release, hl_robot_jahr(lowerWins!), robot_match_kategorie/land/entwickler/fakt, timeline_robot_jahr. Validator: check_literatur_extended + check_robotik_extended. MODES 840→852. verify: 152/152 |
